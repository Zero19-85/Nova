...
dependencies {
    ...
    // All three arrive transitively through material3 today. Declared anyway
    // because this app uses them directly — `combinedClickable` for the host
    // card's tap and hold, `animateContentSize` for the launch row sliding out
    // from under it, and the gear glyph in the top bar — and a transitive
    // dependency that a future material3 drops takes the build with it.
