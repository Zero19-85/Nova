...
- **Live validation needed:** 4K@120 HEVC Main10/HDR10 heavy-pan session — expect flat frame cadence (no rhythmic stutter), `📊 RTP/s` unchanged, no "RTP send queue full" lines on a healthy LAN; regression-check H264/SDR smoothness and static-desktop 0% Video Encode idle.
